 ...
 * <p>
 * <p>
 * Each entry is given a universally unique identifier ({@link UUID})
 * represented by a 128-bit value, by which it is identified on file
...
public class LibraryEntry {
    ...
    public LibraryEntry() {
        ...
        jsonData.add("UUID", new JsonPrimitive(getNewUUID()));
        jsonData.add("Information", new JsonObject());
        jsonData.add("Files", new JsonObject());
    }
